...
const NavbarToolListComponent: React.FC<NavbarToolItemProps> = ({ dropdownPlacement = 'bottom', dropdown, icon, className, label, type, content, onClick, src, id, elementRef }) =>
{
...
export default NavbarToolListComponent;
