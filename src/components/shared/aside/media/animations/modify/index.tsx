...
interface AsideMediaAnimationsItemOptionProps
{
    id: string;
}

const AsideMediaAnimationsItemOptionComponent: React.FC<AsideMediaAnimationsItemOptionProps> = ({ id }) =>
{
        ...
        <motion.div initial={ { opacity: 0 } } animate={ { opacity: 1 } } className='nav-wrapper h-full overflow-hidden py-6'>
            <div className='mx-auto -mt-2 mb-2 flex w-[calc(100%-2rem)] gap-2'>
                <button
                    ...
                    onClick={ () => dispatch(setAsideOption('MEDIA_ANIMATIONS')) }
                >
                    <FaArrowLeft/>
                </button>
...
export default AsideMediaAnimationsItemOptionComponent;
