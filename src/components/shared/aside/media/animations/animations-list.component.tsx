...
interface AsideMediaAnimationsListOptionProps
{
    id: string;
}

const AsideMediaAnimationsListOptionComponent: React.FC<AsideMediaAnimationsListOptionProps> = ({ id }) =>
{
...
export default AsideMediaAnimationsListOptionComponent;
