...
import data from '@/components/shared/aside/media/animations/modify/data';

import InputComponent from '@/components/ui/input.component';
import ButtonComponent from '@/components/ui/button.component';
import CustomRangeInputComponent from '@/components/ui/custom-range-input.component';

interface AsideNavAnimationsItemOptionProps
{
    id: string;
}

const AsideNavAnimationsItemOptionComponent: React.FC<AsideNavAnimationsItemOptionProps> = ({ id }) =>
{
            ...
            <div className='custom-scrollbar mt-6 size-full max-h-[calc(100vh-12rem)] overflow-y-auto'>
                ...
                <div className="flex flex-col gap-2 px-4">
                    ...
                    <div className='mt-4 flex flex-col divide-y divide-slate-150 rounded-lg border border-slate-150 dark:divide-navy-500 dark:border-navy-500'>
                        <div className='ac'>
                            <div
                                className='ac-trigger flex cursor-pointer items-center justify-between p-4 text-base font-medium text-slate-700 dark:text-navy-100 sm:px-5'
...
export default AsideNavAnimationsItemOptionComponent;
