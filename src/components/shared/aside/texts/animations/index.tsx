...
import data from '@/components/shared/aside/texts/animations/data';

import AnimationsItemComponent from '@/components/shared/aside/texts/animations/animations-item.component';
import AnimationsSwiperComponent from '@/components/shared/aside/texts/animations/animations-styled-swiperjs.component';

const AsideTextsAnimationsOptionComponent = () =>
{
...
export default AsideTextsAnimationsOptionComponent;
