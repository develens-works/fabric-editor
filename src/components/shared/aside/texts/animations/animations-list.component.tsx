...
interface AsideTextsAnimationsListOptionProps
{
    id: string;
}

const AsideTextsAnimationsListOptionComponent: React.FC<AsideTextsAnimationsListOptionProps> = ({ id }) =>
{
...
export default AsideTextsAnimationsListOptionComponent;
